---
name: plugin-auditor
description: Use this agent when the user asks to "validate my plugin", "check plugin structure", "verify plugin is correct", "validate plugin.json", "check plugin files", or mentions plugin validation. Also trigger proactively after user creates or modifies plugin components.\n\n<example>\n\nContext: User finished creating a new plugin.\n\nuser: "I've created my first plugin with commands and hooks"\n\nassistant: "I'll use the plugin-validator agent to check the plugin."\n\n<commentary>\n\nPlugin created, proactively validate to catch issues early.\n\n</commentary>\n\n</example>\n\n<example>\n\nContext: User explicitly requests validation.\n\nuser: "Validate my plugin before I publish it"\n\nassistant: "I'll use the plugin-validator agent to perform comprehensive validation."\n\n<commentary>\n\nExplicit validation request triggers the agent.\n\n</commentary>\n\n</example>\n\n<example>\n\nContext: User modified plugin.json.\n\nuser: "I've updated the plugin manifest"\n\nassistant: "I'll use the plugin-validator agent to check the manifest."\n\n<commentary>\n\nManifest modified, validate to ensure correctness.\n\n</commentary>\n\n</example>
type: quality
permissionMode: plan
tools: Bash, Glob, Grep, Read
skills: 'claude-plugin-settings, claude-plugin-structure, claude-skill-write'
model: opus
color: red
---
