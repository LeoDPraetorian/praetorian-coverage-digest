...
AskUserQuestion({
  questions: [{
    question: "Iteration limit (10) reached. Current status: 2 of 5 tests still failing. How to proceed?",
    header: "Iteration Limit",
    multiSelect: false,
    options: [
...
AskUserQuestion({
  questions: [{
    question: "Loop detected - same output pattern repeated 3 times: \"error:TypeError-null-auth.ts\". How to proceed?",
    header: "Loop Detected",
    multiSelect: false,
    options: [
      { label: "Try different approach", description: "Continue with explicit instruction to change strategy" },
