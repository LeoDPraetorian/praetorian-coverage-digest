...
threat-modeling-orchestrator
  ...
  ├── Phase 2: codebase-sizing → codebase-sizer agent
...
- [threat-modeling-orchestrator SKILL.md](/.claude/skills/threat-modeling-orchestrator/SKILL.md) - Orchestrator that spawns this agent
