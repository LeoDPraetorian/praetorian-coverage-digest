...
## Tools That Use This Mechanism

These open-source tools parse the same JSONL files:

- [ccusage](https://github.com/ryoppippi/ccusage) - CLI usage analyzer
- [claude-code-statusline](https://github.com/levz0r/claude-code-statusline) - Real-time status line
- [CCometixLine](https://github.com/Haleclipse/CCometixLine) - Rust-based status line
