...
- **Output**: "Implement the following feature: [TICKET CHA-1232: Full details...]"
...
6. **Automatic Reference Resolution**: Detect and resolve Jira ticket references in user input

## Preprocessing Mode Operations
...
- **Vague requirements** → `intent-translator`
