...
**ACTION:** Invoke the `managing-agents` skill immediately.
...
**Note:** The `managing-agents` skill delegates to operation-specific skills that handle all workflow complexity, including TDD cycles, interactive user prompts, and validation.
