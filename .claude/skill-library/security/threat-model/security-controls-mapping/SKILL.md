...
**FACT**: The `threat-modeling-orchestrator` skill (`.claude/skill-library/security/threat-model/threat-modeling-orchestrator/`) loads these files by exact name:
...
- `sizing-codebases` - Phase 2: Sizing analysis before mapping
