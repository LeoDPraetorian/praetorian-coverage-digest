...
Catch missing requirements before Phase 8 (Code Review), where they're harder to identify among quality issues.
...
**Mandatory checkpoint** between Phase 6 (Implementation) and Phase 8 (Code Review):

```
Phase 5: Implementation
        ↓
Phase 7: Plan Completion Review ← YOU ARE HERE
        ↓
Phase 6: Code Review
```
...
1. Return to Phase 6 (Implementation)
  ...
  questions: [{
    ...
    options: [
      ...
      },
      {
        ...
        description: "Return to Phase 6 to implement"
      }
    ]
  }]
})
...
```
TodoWrite: Mark "Phase 7: Plan Completion Review" as completed
...
- Missing requirements found in Phase 11 (test validation) - very expensive
...
- [Phase 7: Code Review](phase-8-code-review.md) - Next phase (quality focus)
