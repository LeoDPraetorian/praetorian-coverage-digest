...
- **Import:** `import { aegisList } from '$ROOT/.claude/tools/praetorian-cli/aegis-list.ts'`
...
- **Import:** `import { assetsGet } from '$ROOT/.claude/tools/praetorian-cli/assets-get.ts'`
...
- **Import:** `import { assetsList } from '$ROOT/.claude/tools/praetorian-cli/assets-list.ts'`
...
- **Import:** `import { attributesGet } from '$ROOT/.claude/tools/praetorian-cli/attributes-get.ts'`
...
- **Import:** `import { attributesList } from '$ROOT/.claude/tools/praetorian-cli/attributes-list.ts'`
...
- **Import:** `import { capabilitiesList } from '$ROOT/.claude/tools/praetorian-cli/capabilities-list.ts'`
...
- **Import:** `import { integrationsList } from '$ROOT/.claude/tools/praetorian-cli/integrations-list.ts'`
...
- **Import:** `import { jobsGet } from '$ROOT/.claude/tools/praetorian-cli/jobs-get.ts'`
...
- **Import:** `import { jobsList } from '$ROOT/.claude/tools/praetorian-cli/jobs-list.ts'`
...
- **Import:** `import { keysList } from '$ROOT/.claude/tools/praetorian-cli/keys-list.ts'`
...
- **Import:** `import { preseedsList } from '$ROOT/.claude/tools/praetorian-cli/preseeds-list.ts'`
...
- **Import:** `import { risksGet } from '$ROOT/.claude/tools/praetorian-cli/risks-get.ts'`
...
- **Import:** `import { risksList } from '$ROOT/.claude/tools/praetorian-cli/risks-list.ts'`
...
- **Import:** `import { searchByQuery } from '$ROOT/.claude/tools/praetorian-cli/search-by-query.ts'`
...
- **Import:** `import { seedsList } from '$ROOT/.claude/tools/praetorian-cli/seeds-list.ts'`
...
```bash
ROOT="$(git rev-parse --show-superproject-working-tree --show-toplevel | head -1)" && npx tsx -e "(async () => {
  const { risksGet } = await import('$ROOT/.claude/tools/praetorian-cli/risks-get.ts');
...
```bash
ROOT="$(git rev-parse --show-superproject-working-tree --show-toplevel | head -1)" && npx tsx -e "(async () => {
  const { jobsList } = await import('$ROOT/.claude/tools/praetorian-cli/jobs-list.ts');
...
```bash
ROOT="$(git rev-parse --show-superproject-working-tree --show-toplevel | head -1)" && npx tsx -e "(async () => {
  const { jobsGet } = await import('$ROOT/.claude/tools/praetorian-cli/jobs-get.ts');
...
ROOT="$(git rev-parse --show-superproject-working-tree --show-toplevel | head -1)" && npx tsx -e "(async () => {
  const { toolName } = await import('$ROOT/.claude/tools/praetorian-cli/tool-name.ts');
