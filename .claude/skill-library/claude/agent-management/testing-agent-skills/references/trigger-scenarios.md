...
**When to read**: Step 4 of testing-agent-skills workflow (designing trigger scenarios)
...
After reading trigger scenarios, return to testing-agent-skills workflow Step 4.
