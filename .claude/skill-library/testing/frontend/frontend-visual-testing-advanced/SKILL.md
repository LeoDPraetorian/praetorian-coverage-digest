---
name: frontend-visual-testing-advanced
description: Use when testing visual regressions - pixel-perfect screenshots, AI-powered diffs, responsive and cross-browser validation
