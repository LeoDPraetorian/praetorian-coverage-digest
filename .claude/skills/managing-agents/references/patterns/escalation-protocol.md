...
| ------------ | ------------------------ | -------------------------- |
| frontend     | frontend-architect       | frontend-security-reviewer |
| backend      | backend-architect        | backend-security-reviewer  |
| testing      | test-architect           | security-architect         |
| research     | -                        | security-architect         |
