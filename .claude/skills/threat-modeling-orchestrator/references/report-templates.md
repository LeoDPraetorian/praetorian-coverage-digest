      ...
      "items": {
        ...
        "properties": {
          ...
          "cvss": {
            "type": "object",
            "properties": {
              "environmental": {"type": "object", "properties": {"score": {"type": "number"}}},
              "overall": {"type": "object", "properties": {"score": {"type": "number"}, "severity": {"type": "string"}}}
            }
          }
        }
      }
        ...
        "rules": [
          {
            ...
            "properties": {
              ...
              "cvss": {
                ...
                "overallScore": 9.3,
                "severity": "Critical",
                "vector": "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:L/VA:N/SC:N/SI:N/SA:N/E:A/CR:H/IR:H/AR:M"
              }
            }
          }
        ]
