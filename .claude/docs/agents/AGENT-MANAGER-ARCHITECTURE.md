...
```
 ...
 LAYER 3: SPECIALIZED SUB-SKILLS (8 operations)
  ...
  INSTRUCTION-BASED:
   ...
   verifying-agent-skill-invocation - Behavioral + pressure testing
...
| `/agent-manager test X [skill]`           | agent-manager managing-agents verifying-agent-skill-invocation | No (Task tool)       | No               |
...
```
 ...
 Phase 10: REFACTOR (Pressure Testing)
    ...
    Uses verifying-agent-skill-invocation
...
```
 ...
 LAYER 3: SUB-SKILLS
  ...
  Usage:
   ...
   Skill: Invoke verifying-agent-skill-invocation (REFACTOR)
  ...
  verifying-agent-skill-invocation
...
| **Behavioral Testing**  | pressure-testing-skill-content             | verifying-agent-skill-invocation          |
