---
name: creating-mocks
description: Use when writing Vitest tests with mocks, fixtures, or test data - covers vi.mock patterns, MSW setup, factory patterns, TanStack Query testing, and test isolation strategies
...
- **[developing-with-tdd](../../development/developing-with-tdd/SKILL.md)** - Write tests first
- **[verifying-before-completion](../../verification/verifying-before-completion/SKILL.md)** - Run tests before claiming done
