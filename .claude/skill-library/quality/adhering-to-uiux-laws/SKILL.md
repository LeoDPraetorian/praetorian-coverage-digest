...
const menuItems = [
  'Profile', 'Password', 'Email', 'Notifications', 'Privacy',
  'Security', 'Billing', 'Subscription', 'API Keys', 'Webhooks',
  'Integrations', 'Export', 'Import', 'Logs', 'Advanced'
];
...
- **frontend-architecture** - Component structure and state management patterns
