...
```json
{
  ...
  "crown_jewels_affected": ["customer_data", "financial_records", "user_credentials"],
  ...
  "control_categories": ["authentication", "authorization", "input-validation"],
  "control_gaps": [
    {
      "gap_id": "GAP-001",
      "gap_type": "weak",
  ...
  "recommendations": [
    ...
    },
    {
      ...
      "files_to_modify": ["modules/chariot/backend/test/integration/isolation_test.go"]
    }
  ],
  "compliance_impact": [
    {
