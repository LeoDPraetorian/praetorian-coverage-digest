1️⃣ Agents (Architecture, Sub-Agents, Multi-Agent Orchestration)
...
4️⃣ Skills (Tools, Best Practices, Skill Design)
...
7️⃣ Security & Vulnerabilities in Agents
...
8️⃣ Claude 4.5 Model Updates & Migration
