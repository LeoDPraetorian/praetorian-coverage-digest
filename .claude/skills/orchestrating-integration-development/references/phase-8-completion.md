...
Phase 8 performs final verification of all requirements, updates metadata to complete status, and presents options for merging or creating a PR. This phase uses the `finishing-a-development-branch` skill for the final workflow.
...
- [ ] All prior phases complete (1-7 or 1-6 if Phase 7 skipped)
- [ ] P0 compliance verified (Phase 4.5)
- [ ] All reviews passed (Phase 5)
- [ ] All tests passing with ≥80% coverage (Phase 6)
- [ ] Frontend integration complete (Phase 7) OR documented skip
...
# Frontend verification (if Phase 7 ran)
...
- [ ] Frontend verification passed (if Phase 7 ran)
...
- **Phase 6 (Testing)**: Provides test baseline
- **Phase 7 (Frontend)**: Determines if frontend verification needed
