# Phase 6: Per-Task Implementation Mode
...
At Phase 6 entry, count tasks in plan.md:
...
- [Phase 5: Implementation](phase-6-implementation.md) - Batch mode workflow
- [Phase 6: Code Review](phase-8-code-review.md) - Phase-level review patterns
