...
## Phase 1.3: RED Capture Template
...
Task(
  ...
  prompt: """
  Scenario: {exact scenario from Phase 1.2}
...
## Phase 8.1: GREEN Verification Template
...
Task(
  ...
  Scenario: {exact same scenario from Phase 1.2}
