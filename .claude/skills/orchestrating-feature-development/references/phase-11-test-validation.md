...
The test-lead validates implementation against the test plan created in Phase 11, ensuring the plan was followed.
...
```
TodoWrite: Mark "Phase 11: Test Validation" as completed
TodoWrite: Mark "Phase 12: Completion" as in_progress
```

## Exit Criteria

✅ Proceed to Phase 12 (Completion) when:
...
- [Phase 8: Test Planning](phase-9-test-planning.md) - Test plan creation
- [Phase 9: Testing](phase-10-testing.md) - Previous phase (test implementation)
