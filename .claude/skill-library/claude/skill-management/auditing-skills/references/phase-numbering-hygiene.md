...
- [updating-skills Phase Numbering Rule](.claude/skill-library/claude/skill-management/updating-skills/SKILL.md#step-36-phase-numbering-rule-mandatory)
- [updating-skills Phase 4b Workflow](.claude/skill-library/claude/skill-management/updating-skills/references/update-workflow.md#phase-4b-inline-edit)
