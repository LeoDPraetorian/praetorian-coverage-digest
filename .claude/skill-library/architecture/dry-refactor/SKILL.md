---
name: dry-refactor
description: Use when eliminating code duplication through DRY (Don't Repeat Yourself) refactoring - code has repetition, similar patterns, duplicate logic, numbered variables (data1, data2), parallel function names (handleXClick), repeated validation, multiple switch statements, or when extracting common functionality into reusable abstractions. Applies Rule of Three, extract function, parameterize, polymorphism, strategy pattern, and configuration-over-code techniques.
