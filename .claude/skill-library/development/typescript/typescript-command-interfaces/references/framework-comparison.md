...
| Framework          | Stars | Bundle Size | TypeScript           | Best For            | PAI Tier          |
| ------------------ | ----- | ----------- | -------------------- | ------------------- | ----------------- |
...
program.name("mycli").description("Production CLI tool").version("1.0.0");
...
export default class Hello extends Command {
  ...
  static examples = ["<%= config.bin %> <%= command.id %> --name World"];
