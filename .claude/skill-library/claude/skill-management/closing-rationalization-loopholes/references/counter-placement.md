...
```
Start: Observed rationalization

Q0: Was this main Claude or a subagent?
├─ Main Claude → Q1a: Specific to one skill?
│  ├─ YES → Skill-specific counter in that skill's ## Red Flags
│  └─ NO → Universal counter in using-skills
│
└─ Subagent → Q1b: Specific to one agent?
...
### Main Claude (Not Subagent)

**When to use:**

- Main Claude (orchestrator) rationalized skipping a skill
- Pattern not specific to any subagent
...
Main Claude skipped `debugging-systematically` saying "This bug looks obvious"

→ Add counter to `.claude/skills/debugging-systematically/SKILL.md` in ## Red Flags section
...
- [ ] .claude/docs/agents/AGENT-LOOPHOLES.md entry created
