...
**CRITICAL:** All testers must follow the test plan created by test-lead in Phase 11.
...
3. If implementation bug: Return to Phase 6 (Implementation)
4. If test issue: Document for Phase 11 (Test Validation)
...
```
TodoWrite: Mark "Phase 10: Testing" as completed
TodoWrite: Mark "Phase 11: Test Validation" as in_progress
```

## Exit Criteria

✅ Proceed to Phase 11 (Test Validation) when:
...
**Solution**: Document for Phase 11 (Test Validation). The test-lead will flag flakiness as a quality issue.

### "Coverage is below target"

**Solution**: Document current coverage. Test-lead in Phase 11 will determine if additional tests are needed.
...
- [Phase 8: Test Planning](phase-9-test-planning.md) - Previous phase (test plan creation)
- [Phase 10: Test Validation](phase-11-test-validation.md) - Next phase (validation against plan)
