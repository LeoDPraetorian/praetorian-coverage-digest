---
description: Use when creating Claude Code plugins - guided workflow with design, implementation, validation
...
- **Load relevant skills**: Use the Skill tool to load plugin-dev skills when needed (claude-plugin-structure, hook-development, agent-development, etc.)
...
**MUST load claude-plugin-structure skill** using Skill tool before this phase.

**Actions**:

1. Load claude-plugin-structure skill to understand component types
...
- Settings: Load claude-plugin-settings skill
...
1. Load claude-plugin-settings skill using Skill tool
...
- **Phase 5**: skill-development, command-development, agent-development, hook-development, mcp-integration, claude-plugin-settings (as needed)
