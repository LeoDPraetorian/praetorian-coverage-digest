...
Track rationalization failures and their counters using `closing-skill-loopholes` methodology.
...
| Description Hallucination | Inventing skill description to justify non-use | closing-skill-loopholes |
