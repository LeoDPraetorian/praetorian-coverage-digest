...
**Location**: `.claude/.output/capabilities/{YYYY-MM-DD-HHMMSS}-{protocol}-fingerprintx/`
...
- **Analysis Date**: {YYYY-MM-DD-HHMMSS}
...
**Protocol Research**: [Inline below / Linked in .claude/.output/capabilities/]
...
**Version Matrix**: [Inline below / Linked in .claude/.output/capabilities/ / N/A]
