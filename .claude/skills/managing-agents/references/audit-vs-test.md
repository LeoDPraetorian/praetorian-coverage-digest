...
| **Implementation** | Uses `auditing-agents` skill (Phase 0: `audit-critical.ts`, Phases 1-18: manual procedures)                                        | Uses `testing-agent-skills` skill (delegates to `testing-skills-with-subagents` for pressure scenarios)                                    |
