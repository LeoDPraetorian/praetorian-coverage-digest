# perplexity_research - Schema Discovery
...
**Discovery Date:** 2025-12-31T01:21:27.913Z
...
### Test Case 1: Research topic with citations
...
### Test Case 2: Technical research with strip_thinking
...
```json
{
  "messages": [
    {
      "role": "user",
      "content": "Compare different approaches to state management in React applications"
    }
  ],
  "strip_thinking": true
}
...
### Test Case 3: Historical research without strip_thinking
...
```json
{
  "messages": [
    {
      "role": "user",
      "content": "Timeline of major web framework developments 2020-2025"
    }
  ],
