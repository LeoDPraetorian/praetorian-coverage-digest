...
The test-lead creates a **test plan** that testers implement in Phase 11, ensuring comprehensive, high-quality test coverage.
...
Return JSON:
{
  ...
  'handoff': {
    ...
    'context': 'Implement tests according to plan in Phase 11'
  }
}
"
)
...
```
TodoWrite: Mark "Phase 9: Test Planning" as completed
TodoWrite: Mark "Phase 10: Testing" as in_progress
```

## Exit Criteria

✅ Proceed to Phase 10 (Testing) when:
...
- [Phase 7: Code Review](phase-8-code-review.md) - Previous phase
- [Phase 9: Testing](phase-10-testing.md) - Next phase (testers implement plan)
- [Phase 10: Test Validation](phase-11-test-validation.md) - test-lead validates against plan
