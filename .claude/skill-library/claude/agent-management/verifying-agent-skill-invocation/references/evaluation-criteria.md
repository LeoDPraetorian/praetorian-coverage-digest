...
**When to read**: Step 6 of verifying-agent-skill-invocation workflow
...
**Reality**: That's pressure testing (pressure-testing-skill-content), not integration testing
